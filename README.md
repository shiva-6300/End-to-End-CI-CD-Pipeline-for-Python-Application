...
Developer │ │ Push Code ▼ GitHub Repository │ │ Webhook Trigger ▼ Jenkins Pipeline │ │ Build Docker Image ▼ Docker Container │ │ Deploy Container ▼ AWS EC2 Instance │ │ Reverse Proxy ▼ Nginx Server │ ▼ Flask Web Application
3. Technologies Used
...
1. Future Improvements 1.Deploy application using Kubernetes 2.Use Terraform for AWS infrastructure 3.Push Docker images to AWS ECR 4.Implement Prometheus monitoring 5.Create Grafana dashboards 6.Add automated testing stage 7.Implement Blue-Green Deployment
2. Author Shiva Aspiring DevOps Engineer GitHub: __https://github.com/shiva-6300__

i want neat struture in read me
